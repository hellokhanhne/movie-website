            ...
            <Tooltip title={t("Click to change language")}>
                ...
                >
                    <div className="cursor-pointer flex">
                        <ImageCustom src={globalLocale === "vi-VN" ? iconImg.flagVn : iconImg.flagUs} width="25px" />
                    </div>
                    <p className="text-[16px] ml-2 text-white">{globalLocale === "vi-VN" ? "Viet Nam" : "English"}</p>
                </div>
            </Tooltip>
        </div>
    );
