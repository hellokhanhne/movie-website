...
const RegisterPage = () => {
    ...
    const onFinish = async (values) => {
        ...
        const nameUser = nameCheck.concat(values.firstName ? " " : "", values.lastname ? values.lastname : "");
        setIsLoading(true);
    ...
    return (
        <div>
            ...
            <div className="px-3 sm:px-0 absolute top-[70px] sm:top-[50%] left-0 right-0 sm:left-[50%] sm:-translate-x-1/2 sm:-translate-y-1/2 pb-8 sm:pb-0 w-full sm:max-w-[550px] sm:w-[550px] text-center leading-relaxed ">
                <p className="text-[white] text-[25px] sm:text-[30px] font-bold">{t("Register Account")}</p>
          ...
          {t("Or register with email account")}
                ...
                <div className="text-center mt-9">
                    ...
                    >
                        ...
                        <Form.Item
                            ...
                            style={{ flex: "1" }}
                        >
                            <StyleInput placeholder={t("hoangminhhoai@gmail.com")} />
                        </Form.Item>
                        <Form.Item
                            label={
                                <label
              ...
              `}
                        ...
                        <div className="text-white text-[16px] mt-4">
                            ...
                            <Link to="/login">
                                <span className="underline text-primarybg font-bold">{t("Login")}</span>
                            </Link>
                        </div>
                    </Form>
                </div>
