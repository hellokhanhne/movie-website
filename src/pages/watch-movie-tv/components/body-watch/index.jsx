    ...
    return (
        <>
            <div className="mt-[128px] text-[#fff]">
                <p className="uppercase underline font-medium text-primarybg text-[20px]">{t("information")}</p>
              ...
              {isLoadingDetail ? (
                ...
                />
                        ...
                        <h3 className="text-white text-[16px] mt-6">
                            {t("Cast")}: &nbsp;
                            {!listCastsMovie?.length && <span className="text-[16px]">{t("Updating")}...</span>}
                        </h3>
                                            ...
                                            <Skeleton loading={isLoadingDetail} active avatar>
                                                <div className="max-w-[65px] w-full h-[65px]">
                                                    <img
                                                        ...
                                                        src={
                                                            getImage(cast.profile_path, "w185").includes("null")
                                                                ? iconImg.Img404
                        ...
                        <div className="flex flex-wrap gap-2 text-[14px] text-yellow-200 mt-8">
                            ...
                            {!listKeywordsMovie?.length && <span className="text-[16px]">{t("Updating")}...</span>}
                        </div>
                    </div>
                ) : (
                    <div className="mt-6">
