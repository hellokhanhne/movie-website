...
const LoginPage = () => {
    ...
    const handleSignInWithGoogle = async () => {
        try {
            ...
            const authentication = getAuth();
            const res = await signInWithPopup(authentication, provider);
            const { oauthAccessToken: accessToken, refreshToken, displayName, email } = res._tokenResponse;
    ...
    return (
        <div className="h-[100vh]">
            <video autoPlay loop muted className="fixed object-cover left-0 h-full w-full inset-0 -z-10">
            ...
            <div className="absolute left-0 right-0 px-3 sm:p-0 top-[50%] sm:left-[50%] sm:-translate-x-1/2 -translate-y-1/2 w-full sm:max-w-[500px] text-center leading-relaxed ">
                ...
                <div>
                    <div className="flex justify-center gap-5 mt-3">
                        <p className="w-[50px] h-[50px] bg-[#fff] rounded-full flex items-center justify-center cursor-pointer hover:scale-110 duration-200">
                            <img src={iconImg.googleImg} alt="" onClick={handleSignInWithGoogle} />
                        </p>
                        {/* <p className="w-[50px] h-[50px] bg-[#fff] rounded-full flex items-center justify-center cursor-pointer hover:scale-110 duration-200">
              <img
              ...
              />
                ...
                <p className="text-center mt-5 text-white font-[300]">{t("Or login with email account")}</p>
                <div className="text-center mt-9">
                    ...
                    >
                        ...
                        >
                            <StyleInput placeholder="hoangminhhoai13g@gmail.com" />
                        </Form.Item>
              ...
              `}
                        ...
                        <div className="text-white text-[16px] mt-4">
                            ...
                            <Link to="/register">
                                <span className="underline text-primarybg font-bold">{t("Register")}</span>
                            </Link>
                        </div>
                    </Form>
                </div>
