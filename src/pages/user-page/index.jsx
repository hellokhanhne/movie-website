import { faCircleUser, faEye, faEyeSlash, faUpload, faUserSlash } from "@fortawesome/free-solid-svg-icons";
...
const UserPage = () => {
    ...
    const handleVerifyEmail = () => {
        ...
        sendEmailVerification(auth.currentUser).then((data) => {
            ...
            handlePopupNotification(`Verification email has been sent to`, "success", dataUser.email);
    ...
    const handleFinishSuccess = async (values) => {
        ...
        // get credential
        const credential = EmailAuthProvider.credential(auth.currentUser.email, dataPassword);
        try {
    ...
    const handleOpenEditUserName = () => {
        ...
        setNameUser(dataUser?.displayName ? dataUser?.displayName : dataUser?.email?.replace("@gmail.com", ""));
        // userRef.current = ;
    };
        ...
        <div className="min-h-[100vh]">
            ...
            >
                <div className="flex flex-col items-stretch">
                    <p className="text-[18px] mb-4 text-center">{t("Enter your password")}</p>
                    <Form
                        form={form}
                ...
                <Col xs={24} lg={16} className="relative pb-[100px]">
                    <div className="max-w-[800px]">
                        ...
                        <div>
                            ...
                            <p className="text-[15px] ">{t("Here you can edit public information about yourself")}.</p>
                ...
                "
                            ...
                            <div className="w-[250px] h-[250px] flex justify-center items-center relative">
                                <Avatar
                                    ...
                                    icon={<FontAwesomeIcon icon={faCircleUser} className="w-full h-full" />}
                ...
                "
                        ...
                        >
                            {isLoadingAvatar ? (
                                ...
                                <FontAwesomeIcon icon={faUpload} beat className="text-primary text-[16px]" />
                            )}
